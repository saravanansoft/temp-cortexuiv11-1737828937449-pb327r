<script lang="ts">
  ...
  import HobbiesForm from '../forms/HobbiesForm.svelte';
...
<div class="bg-white rounded-lg shadow overflow-hidden">
  ...
  >
    <span class="text-lg font-semibold">Hobbies & Interests</span>
    <svg
  ...
  {#if expanded}
    <div class="p-6">
      <HobbiesForm hobbies={user.hobbies} onSave={handleSave} />
    </div>
  {/if}
</div>