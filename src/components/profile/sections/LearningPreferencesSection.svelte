<script lang="ts">
  ...
  import LearningPreferencesForm from '../forms/LearningPreferencesForm.svelte';
...
<div class="bg-white rounded-lg shadow overflow-hidden">
  ...
  >
    <span class="text-lg font-semibold">Learning Preferences</span>
    <svg
  ...
  {#if expanded}
    <div class="p-6">
      <LearningPreferencesForm preferences={user.learningPreferences} onSave={handleSave} />
    </div>
  {/if}
</div>